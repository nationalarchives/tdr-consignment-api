...
libraryDependencies ++= Seq(
  ...
  "uk.gov.nationalarchives" %% "tdr-metadata-validation" % "0.0.123",
  ...
  "software.amazon.awssdk" % "rds" % "2.31.21",
  "software.amazon.awssdk" % "sts" % "2.31.21",
  ...
  "io.github.hakky54" % "logcaptor" % "2.10.2" % Test,
