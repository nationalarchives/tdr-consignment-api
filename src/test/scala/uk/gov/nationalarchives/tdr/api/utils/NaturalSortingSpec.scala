...
class NaturalSortingSpec extends AnyFlatSpec {
  ...
  val list1: Seq[String] = List("test file1", "test file11", "test file2", "test file3", "test file31", "test file4", "test file21",
  ...
  val expectedList3: Seq[String] = List("test1 file", "test2 file", "test3 file", "test5 file", "test11 file", "test12 file",
                                        "test21 file", "test31 file", "test file22")
