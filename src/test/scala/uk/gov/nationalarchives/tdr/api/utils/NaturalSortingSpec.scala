...
class NaturalSortingSpec extends AnyFlatSpec {
  ...
  val list2: Seq[String] = List("test file 1", "test file 11", "test file 2", "test file 3", "test file 31", "test file 4", "test file 21", "test file 23", "test file 22")
  val expectedList2: Seq[String] = List("test file 1", "test file 2", "test file 3", "test file 4", "test file 11", "test file 21", "test file 22", "test file 23", "test file 31")
  ...
  val expectedList4: Seq[String] = List("test1.1 file", "test1.2 file", "test2.0 file", "test2.1 file", "test3.1 file", "test3.3 file", "test22 file", "test file22", "test file")
