...
trait GraphQLServerBase {
  ...
  protected def generateConsignmentApiContext(accessToken: Token, db: slick.jdbc.PostgresProfile.api.Database)(implicit ec: ExecutionContext): ConsignmentApiContext = {
