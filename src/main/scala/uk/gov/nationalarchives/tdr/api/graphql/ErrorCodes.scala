...
/** GraphQL supports arbitrary error codes to provide extra error information to client applications. These error codes are added to the error object under `extensions.code`.
  *
