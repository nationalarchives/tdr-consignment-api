...
import uk.gov.nationalarchives.tdr.api.service.FileService.PaginatedFiles
...
case class DeferPaginatedFiles(consignmentId: UUID, paginationInput: PaginationInput, fileFilters: Option[FileFilters] = None)
